...
namespace SharedControls.Controls
{
    ...
    public class HamburgerMenuItem : AvaloniaObject, IHamburgerMenuItem
    {
        ...
        public static readonly StyledProperty<bool> EnabledProperty =
            AvaloniaProperty.Register<HamburgerMenuItem, bool>(
                nameof(Enabled), true);
        ...
        public static readonly StyledProperty<object?> IconProperty =
            AvaloniaProperty.Register<HamburgerMenuItem, object?>(
                nameof(Icon));
        ...
        public static readonly StyledProperty<IDataTemplate?> IconTemplateProperty =
            AvaloniaProperty.Register<HamburgerMenuItem, IDataTemplate?>(
        ...
        /// </summary>
        public static readonly DirectProperty<HamburgerMenuItem, object?> TagProperty =
            AvaloniaProperty.RegisterDirect<HamburgerMenuItem, object?>(
                nameof(Tag), o => o.Tag, (o, v) => o.Tag = v);

        /// <summary>
        ///     Defines the dependency property that controls whether the item is automatically hidden when the navigation pane
        ///     enters compact (collapsed) mode.
        ...
        /// <summary>
        ///     Gets or sets whether the menu item should be automatically hidden when the navigation pane is in compact mode
        ///     (e.g., on small screens).
