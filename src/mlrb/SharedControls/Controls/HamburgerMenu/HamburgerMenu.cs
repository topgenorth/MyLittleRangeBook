...
namespace SharedControls.Controls
{
    ...
    public class HamburgerMenu : HeaderedContentControl
    {
        ...
        /// </summary>
        public static readonly StyledProperty<double> AutoClosePaneThresholdProperty =
        ...
        /// </summary>
        bool _wasPaneOpenBeforeAutoCollapse = true;
        ...
        /// </summary>
        void MenuItemsCollectionOnCollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
