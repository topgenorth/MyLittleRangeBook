...
namespace SharedControls.Converters
{
    ...
    ///     - Smart foreground selection: {Binding BackgroundColor, Converter={x:Static
    ///     BrushConverters.ColorToForegroundBrushConverter}}
    /// </remarks>
    public static class BrushConverters
    {
        ...
        /// <remarks>
        ///     Example XAML usage:
        ///     <TextBlock Foreground="{Binding Background, Converter={x:Static BrushConverters.ColorToForegroundBrushConverter}}"
        ///         Text="Hello" />
        ///     How it works:
        ...
        public static FuncValueConverter<Color, SolidColorBrush> ColorToForegroundBrushConverter { get; } =
            new(color => new SolidColorBrush(GetIdeaForegroundColor(color)));
