...
using Npgsql;
namespace MyLittleRangeBook.Database.Postgres
{
    public class PostgresCartridgesDbService : ICartridgesDbService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var cmd = new NpgsqlCommand(DeleteSql, (NpgsqlConnection)connection);
        ...
        public async Task<Result<EntityId>> UpsertAsync(IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            var valuesToInsert = new { cartridge.Id, cartridge.Name, cartridge.CommonName, cartridge.ProjectileDiameterMetric, cartridge.ProjectileDiameterImperial, cartridge.SuitableForRifle, cartridge.SuitableForPistol, cartridge.IsActive };
            try
            {
