...
namespace MyLittleRangeBook.RangeEvents
{
    ...
    public class SqliteSimpleRangeEventService : ISimpleRangeEventService
    {
        private static class Commands
        {
            ...
            private const string DeleteSql = "DELETE FROM simple_range_events WHERE id = @Id;";
            public static DapperCommand UpsertCommand => new(UpsertSql);
            public static DapperCommand DeleteCommand => new(DeleteSql);
            public static DapperCommand SelectAll => new(SelectSql, new { });
        }
