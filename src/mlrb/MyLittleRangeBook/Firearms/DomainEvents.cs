...
namespace MyLittleRangeBook.Firearms
{
    public partial class FirearmAggregate
    {
        ...
        /// This event carries information about the unique identifiers of both the firearm and the range event, as well as the timestamp when the association occurred.
        /// </summary>
        /// <param name="StreamId">
        ...
        /// This event carries information pertaining to the unique identifiers of both the firearm and the asset, as well as the timestamp of when the event occurred.
        /// </summary>
        /// <param name="StreamId">
