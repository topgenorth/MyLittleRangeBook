...
namespace MyLittleRangeBook
{
    ...
    {
        /// <summary>
        ///     Reads a text file that is an embedded resource in an assembly.
        /// </summary>
        ...
        {
            await using Stream? stream = assembly.GetManifestResourceStream(fullResourceName);
            if (stream == null)
            {
        ...
        /// </summary>
        /// <remarks>
        ///     Will clean up information versions that include the full SHA, they look like
