...
namespace MyLittleRangeBook.EventSourcing
{
    ...
    public interface IProjector
    {
        ...
        /// <param name="firearmId">The unique identifier of the event stream (aggregate) to which the events belong.</param>
        /// <param name="uncommittedDomainEvents">
        ///     A collection of domain events to project to the event stream. Can be null if no events are
        ///     provided.
        /// </param>
