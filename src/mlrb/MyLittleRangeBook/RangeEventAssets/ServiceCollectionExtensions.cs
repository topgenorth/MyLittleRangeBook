    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection RegisterRangeAssetHandlers(this IServiceCollection services)
        {
            ...
            services.AddScoped<CopyFileHandler>(serviceProvider =>
                new CopyFileHandler(serviceProvider.GetRequiredService<Microsoft.Extensions.Configuration.IConfiguration>()));
            ...
            services.AddScoped<IPipelineHandler<RangeEventAssetFile>>(sp => sp.GetRequiredService<ValidateFileExistsHandler>());
