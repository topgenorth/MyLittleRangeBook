...
namespace SharedControlsTests
{
    ...
    {
        static Window CreateWindow(object content)
        {
        ...
        {
            var hamburgerMenu = new HamburgerMenu { AutoClosePaneThreshold = 600 };
        ...
        {
            var menu = new HamburgerMenu { AutoClosePaneThreshold = 600, IsPaneOpen = true };
