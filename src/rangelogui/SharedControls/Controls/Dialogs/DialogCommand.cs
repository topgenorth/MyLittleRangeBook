...
#pragma warning restore CS0067
    ...
    public static class DialogCommands
    {
        ...
        /// </summary>
        public static DialogCommand Cancel { get; } = new()
        {
            Caption = "Cancel", IsCancel = true, DialogResult = DialogResult.Cancel
        };
        ...
        /// </summary>
        public static DialogCommand Ok { get; } = new()
        {
            Caption = "OK", IsDefault = true, DialogResult = DialogResult.Ok
        };
        ...
        ///     Marked as the default button (can be triggered by Enter key).
        /// </summary>
        public static DialogCommand Yes { get; } = new()
        {
            Caption = "Yes", IsDefault = true, DialogResult = DialogResult.Yes
        };
        ...
        /// </summary>
        public static DialogCommand No { get; } = new() { Caption = "No", DialogResult = DialogResult.No };
    }
}
