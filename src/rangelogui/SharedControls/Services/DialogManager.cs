...
namespace SharedControls.Services
{
    ...
    public class DialogManager
    {
        ...
        /// </summary>
        static readonly Dictionary<IDialogParticipant, Visual> RegistrationMapper = new();
        ...
        static void RegisterChanged(Visual sender, AvaloniaPropertyChangedEventArgs e)
        {
