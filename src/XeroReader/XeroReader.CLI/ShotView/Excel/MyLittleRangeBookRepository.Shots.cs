...
public partial class MyLittleRangeBookRepository
{
    ...
    private static object ShotToDynamicType(Shot s, string sessionId) => new
    {
        s.Id,
        SessionId = sessionId,
        s.ShotNumber,
    ...
    private async Task<Tuple<Shot[], Shot[], Shot[]>> PutShotNumbersForSessionIntoBuckets(SqliteConnection conn,
