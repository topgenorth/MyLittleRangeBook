...
public class XlsxAdapter : IShotViewXslxAdapter
{
    ...
    public WorkbookSession? GetShotSession(int sheetNumber)
    {
        ...
        WorkbookSession s = new() { FileName = _file.Name, SheetNumber = sheetNumber, SheetName = $"{_file.Name}[{sheetNumber}]" };
    ...
    private void GetProjectileWeightFromWorksheet(WorkbookSession s)
    {
    ...
    private void GetSessionDateFromWorksheet(WorkbookSession s)
    {
    ...
    private void CreateNotesFromWorksheet(WorkbookSession s)
    {
        const string period = ". ";
        const string bullet = "    * ";
    ...
    private void GetShotsFromWorksheet(WorkbookSession s)
    {
        ...
        {
            Shot? shot = new() { CleanBore = row.GetBool("G"), ColdBore = row.GetBool("H"), Notes = row.GetString("I") };
    ...
    private DateTime ConvertShotTimeToShotDateTimeUtc(DateTime sessionDateUtc, string timeText)
    {
